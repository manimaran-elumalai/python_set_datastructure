...
if sample_set2.issubset(sample_set1): # tests if every element in set2 is in set1
    print("sample_set2 is a subset of sample_set1")

print("**" * 10)

if sample_set2.issuperset(sample_set2): # tests if every element in set1 is in set2
